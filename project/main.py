from flask import Blueprint, render_template, Flask, request, url_for, flash, redirect
...
@main.route('/responsavel/<int:post_id>')
def post(post_id):
    responsavel = get_post(post_id)
    return render_template('post.html', post=responsavel)


@main.route('/responsavel/create', methods=('GET', 'POST'))
def create():
    nome = ''
    cpf = ''
    rg = ''
    ...
    if request.method == 'POST':
        ...
        if not nome:
            ...
            conn.commit()
            conn.close()
            return redirect(url_for('main.view_responsavel'))
...
@main.route('/responsavel/<int:id>/edit', methods=('GET', 'POST'))
def edit(id):
...
@main.route('/aluno/<int:id>/edit', methods=('GET', 'POST'))
def edit_aluno(id):
...
@main.route('/aluno/<int:id>/delete', methods=('POST',))
def delete_aluno(id):
...
@main.route('/informacao/<int:post_informacaoid>')
...
@main.route('/informacao/create', methods=('GET', 'POST'))
def create_informacao():
    ...
    if request.method == 'POST':
        ...
        if not remedio:
            ...
            conn.commit()
            conn.close()
            return redirect(url_for('main.view_informacao'))

    return render_template('createinformacao.html', remedio=remedio , informacao=informacao)

@main.route('/informacao/<int:id>/edit', methods=('GET', 'POST'))
...
@main.route('/empresa/<int:post_empresaid>')
...
@main.route('/empresa/create', methods=('GET', 'POST'))
def create_empresa():
    nome = ''
    ...
    if request.method == 'POST':
        ...
        if not nome:
            ...
            conn.commit()
            conn.close()
            return redirect(url_for('main.view_empresa'))

    return render_template('createempresa.html', nome=nome)


@main.route('/empresa/<int:id>/edit', methods=('GET', 'POST'))
def edit_empresa(id):
...
@main.route('/escola/<int:post_escolaid>')
...
@main.route('/escola/create', methods=('GET', 'POST'))
def create_escola():
    nome = ''
    ...
    if request.method == 'POST':
        ...
        if not nome:
            ...
            conn.commit()
            conn.close()
            return redirect(url_for('main.view_escola'))

    return render_template('createescola.html', nome=nome)

@main.route('/escola/<int:id>/edit', methods=('GET', 'POST'))
def edit_escola(id):
